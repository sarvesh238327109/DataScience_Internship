...
INSERT INTO vcet_emp(empid,firstname,lastname,age,gender,department,address,salary)values(1,"Sarvesh","Surve",25,"Male","HR","Dahisar",25000);
INSERT INTO vcet_emp values(2,"Atharva","Rodge",24,"Male","Accountant","Nallasopara",30000),
(3,"Sumeet","Sonawane",28,"Male","Management","Dahanu",60000),
(4,"Yash","Tiwari",26,"Male","IT","Mira Road",79000);
